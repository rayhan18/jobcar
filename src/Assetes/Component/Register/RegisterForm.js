...
class RegisterForm extends Component {
    ...
    formValidation(){
        ...
        if(fname===''){
            this.setState({fnameError:'please enter your company name'})
        }
        else if(lname=== ''){
            ...
            <Fragment>
                ...
                <Container>
                    ...
                    <Row >
                        <Col sm={12} md={6} lg={6}>
                            <Form style={formStyle} className="bg-light p-4">
                                ...
                                <Form.Group as = {Row}controlId="exampleForm.ControlTextarea1">
                                    <Form.Label className="mr-3" column sm="3">Discription </Form.Label>
                        ...
                        <Col sm={12} md={6} lg={6}>
                            <div>
                                <img classname="" src={logoDesign} alt="jobcar"/>
                            </div>
